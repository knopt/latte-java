/**************************************************************
  lib.JLex: A Lexical Analyzer Generator for Java(TM)
  ...
  Version 1.2.6, 2/7/03, [C. Scott Ananian]
   ...
   Fixed a bug which certain forms of comment in the lib.JLex directives section
  ...
  Version 1.2.5, 7/25/99-5/16/00, [C. Scott Ananian]
   ...
   Fixed a bug that would cause lib.JLex not to terminate given certain input
   ...
   CUP parser integration improved according to suggestions made by
     ...
     lib.JLex to generate a parser conforming to the java_cup.runtime.Scanner
   ...
   Fixed 'illegal constant' errors in case statements caused by
     ...
     JLS (15.27) to convince me that the lib.JLex construction actually was
     illegal.  Reported against 1.2.5b6, but this bit of code has been
     present since the very first version of lib.JLex (1.1.1).
  ...
  Notes:
    Simply changed the name from JavaLex to lib.JLex.  No other changes.
...
class CSpec
{
  ...
  CSpec
	...
	/* Initialize variables for lib.JLex runtime options. */
	m_verbose = true;
...
public class Main
{
  ...
  public static void main
	...
	if (arg.length < 1)
	  {
	    System.out.println("Usage: lib.JLex.Main <filename>");
	    return;
	  }
...
class CInput
{
  /***************************************************************
    Member Variables
    **************************************************************/
  private java.io.BufferedReader m_input; /* lib.JLex specification file. */
  ...
  static void impos
    (
     String message
      ...
      {
	System.out.println("lib.JLex Error: " + message);
      }
  ...
  static final String errmsg[] = 
    {
      ...
      "lib.JLex has not been successfully initialized.",
      "Unexpected end-of-file found.",
      "Undefined or badly-formed lib.JLex directive.",
      "Internal lib.JLex error.",
...
class CLexGen 
{
  /***************************************************************
    Member Variables
    **************************************************************/
  private java.io.Reader m_instream; /* lib.JLex specification file. */
  ...
  /***************************************************************
    Member Variables: lib.JLex directives.
    **************************************************************/
  ...
  /***************************************************************
    Function: userRules
    Description: Processes third section of lib.JLex
